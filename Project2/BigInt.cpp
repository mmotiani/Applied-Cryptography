...
BigInt::BigInt BigInt::operator*(BigInt op){
	BigInt response;
...
// Add two BigInts
BigInt::BigInt BigInt::operator+(BigInt::BigInt op){
	BigInt response;
	response = add(n, op.n);
	return response;	
}
...
bool BigInt::operator>=(BigInt::BigInt op){
...
BigInt::BigInt BigInt::operator/(BigInt::BigInt divisor){
	BigInt response;
	BigInt::BigInt quotient;
	BigInt::BigInt dividend = *this;
	BigInt::BigInt origDivisor = divisor;
...
// Shift left
BigInt::BigInt& BigInt::operator<<=(int shift){
	n <<= shift;
	return *this;
}
...
BigInt::BigInt BigInt::exp(int y){
	BigInt::BigInt BIy, response;
	BIy = y;
	response = exp(BIy);
	return response;
}
...
// Calculate this^y using fast exponentiation.
BigInt::BigInt BigInt::exp(BigInt y){
	BigInt result;
